...
Definiciones de métricas, SLO/SLA y glosario compartidos por todos los agentes del proyecto.
...
| **Entity** | Cualquier componente monitoreado: servicio, host, proceso, base de datos |
...
| Resumen diario de tendencias | 1 vez/día (08:00) | Agente daily-summary |
| Reporte de incidente | Bajo demanda | Agente incident-responder |
